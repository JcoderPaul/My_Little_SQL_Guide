...
Берем ту же таблицу customers со следующими полями: customer_id, first_name, last_name, favorite_website
...
Например у нас есть таблица suppliers со следующими данными: supplier_id, supplier_name, city, state.
