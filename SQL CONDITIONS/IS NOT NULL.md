...
возвращает FALSE. Его можно использовать в операторе SELECT, INSERT, UPDATE или 
DELETE.
...
полями: product_id, product_name, category_id.
...
поле fav_website которой будет находится хоть какие нибудь данные не равные NULL, они будут
