...
- replacement_string - не является обязательным. Все вхождения string_to_replace 
                       будут заменены string_to_replace в string1. Если параметр 
                       string_to_replace опущен, то функция REPLACE просто удалит 
                       все вхождения string_to_replace, и вернет получившуюся строку.
